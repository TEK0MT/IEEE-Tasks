...
extern void lcd_send_char(unsigned char The_char);
extern void lcd_send_string(unsigned char *The_char);
extern void lcd_set_position(unsigned char line ,unsigned char pos);
extern void lcd_clear(void);
extern void lcd_send_number(int number);
extern void lcd_send_real_number(float number);
